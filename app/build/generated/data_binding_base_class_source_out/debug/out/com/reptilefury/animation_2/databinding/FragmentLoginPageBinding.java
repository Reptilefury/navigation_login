...
public final class FragmentLoginPageBinding implements ViewBinding {
  ...
  private FragmentLoginPageBinding(@NonNull LinearLayout rootView, @NonNull EditText UserNameField,
  ...
  public static FragmentLoginPageBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentLoginPageBinding((LinearLayout) rootView, UserNameField, loginButton,
          passwordField);
    }
